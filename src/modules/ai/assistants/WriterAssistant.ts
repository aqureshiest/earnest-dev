...
provided task_description, implementation_plan, existing_codebase, and generated_code.

<objective>
Analyze the task, the implementation plan, the existing codebase, and the newly generated code to craft a comprehensive PR description. 
