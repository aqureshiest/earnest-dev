...
export class TasksForCodebaseAssistant2 extends CodebaseAssistant<string> {
...
<objective>
Create a detailed set of Jira epics and tickets that cover all necessary work to implement the changes outlined in the technical design document (TDD), considering the current codebase structure and content.
</objective>

<instructions>
<summary>
* Thoroughly review the technical design document and the provided codebase
* Create epics for major features, changes, or groups of related work described in the TDD
* Break down each epic into specific, actionable tickets
* Ensure each ticket is clear, concise, and actionable
* Reference specific sections of the codebase where relevant
...
* Infer the current system state from the codebase and create tickets to bridge the gap to the TDD requirements
</summary>
...
* Pay attention to the current codebase structure and how new features or changes will integrate with it
</considerations>

<constraints>
* Base your analysis solely on the TDD and the provided codebase
* Do not make assumptions about implementation details not specified in the TDD or evident in the codebase
...
Based on these instructions, create a comprehensive set of Jira epics and tickets to implement the requirements specified in the technical design document, using the specified XML format for your response. Use your understanding of the current codebase to inform how these changes should be implemented.
`;
    }
